...
@endif
	<input type="hidden" name="product_id" value="{{$service->id}}" required>
	<p>
   	...
   	<div class="comment-item col-md-6 pull-left">
   		<div class="panel panel-default comment-data">
			...
			<div class="panel-body">
				...
				@if(Auth::check() && (Auth::user()->id == $comment->user_id || Auth::user()->id == $service->provider_id))
