...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => 'required|email|string|max:250|unique:clients,email,'.
            $this->route('client')->id.'|max:250',

            'address' => 'nullable|string|max:250',

            'curp' => 'required|string|min:18|unique:clients,curp,'.
            $this->route('client')->id.'|max:18',

            'phone' => 'required|string|min:10|unique:clients,phone,'.
